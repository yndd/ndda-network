...
import (
	...
	"github.com/yndd/ndda-network/internal/controllers"

	"github.com/yndd/ndda-network/internal/shared"
)
...
var startCmd = &cobra.Command{
	Use:          "start",
	Short:        "start the network ndda intent manager",
	Long:         "start the network ndda intent manager",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		nddcopts := &shared.NddControllerOptions{
			Logger:    logging.NewLogrLogger(zlog.WithName("network")),
			Poll:      pollInterval,
			Namespace: namespace,
		}
